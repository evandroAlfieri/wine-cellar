...
export function AddWishlistDialog() {
  ...
  return (
    <ResponsiveDialog open={open} onOpenChange={setOpen}>
      ...
      <ResponsiveDialogContent>
        <ResponsiveDialogHeader>
          <ResponsiveDialogTitle>Add Wine to Wishlist</ResponsiveDialogTitle>
        </ResponsiveDialogHeader>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  ...
                  <Popover open={producerOpen} onOpenChange={setProducerOpen}>
                    ...
                    <PopoverContent className="w-[400px] max-w-[var(--radix-popover-content-available-width)] p-0 z-50 bg-popover">
